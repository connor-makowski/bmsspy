...
\BlankLine
$k \leftarrow \max\!\left(2, \lfloor \log(|G|)^{1/3} \rfloor\right)$\;

{\color{blue}$t \leftarrow \max\!\left(2, \lceil \log(|G|)^{2/3} \rceil\right)$ \tcp*{Ceil must be used}\label{alg:bmssp_init_ceil}}
