...
def test_quicksplit():
    ...
    for data in tests:
        ...
        assert sorted(quicksplit_output["lower"]) == sortsplit_output["lower"]
        assert sorted(quicksplit_output["higher"]) == sortsplit_output["higher"]
        assert (
        ...
        assert quicksplit_output["pivot"] == sortsplit_output["pivot"]
